...
from neural_memory_pro.infinitydb.query_planner import (
    QueryExecutor,
    QueryPlan,
    rrf_fuse,
)
...
class TestQueryExecutorFilters:
    ...
    def test_ephemeral_filter(self, stores: tuple) -> None:
        ms, idx, gs = stores
        meta1 = {
            "id": "n1", "type": "fact", "content": "perm", "priority": 5,
            "ephemeral": False, "tags": [], "vec_slot": -1,
            "created_at": "2026-03-20T12:00:00", "updated_at": "2026-03-20T12:00:00",
            "accessed_at": "2026-03-20T12:00:00", "access_count": 0,
            "activation_level": 1.0,
        }
