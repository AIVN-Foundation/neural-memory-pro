...
from neural_memory_pro.infinitydb.compressor import (
    BYTES_PER_DIM,
    CompressionTier,
    VectorCompressor,
)
...
class TestCompressorEdgeCases:
    ...
    def test_compression_ratio(self, compressor: VectorCompressor) -> None:
        ...
        assert compressor.compression_ratio(CompressionTier.ACTIVE, CompressionTier.CRYSTAL) == float("inf")
